...
class InterfaceApp:
    def __init__(self):
        ...
        self.window.entrar = tk.PhotoImage(file="entrar.png")
        self.window.cadastro = tk.PhotoImage(file="cadastro.png")
        self.window.criar = tk.PhotoImage(file="criar.png")
        self.window.amizade = tk.PhotoImage(file="amizade.png")
        self.window.viagens = tk.PhotoImage(file="viagens.png")
        self.window.profissional = tk.PhotoImage(file="profissional.png")
        self.window.relacionamentos = tk.PhotoImage(file="relacionamentos.png")
        self.window.saude = tk.PhotoImage(file="saude.png")
        self.window.perguntar = tk.PhotoImage(file="perguntar.png")
        ...
        self.entrar = tk.Button(self.login_screen, background = 'teal', font=('AR ESSENCE', '18'), fg='floral white')
        ...
        self.criar_novo_usuario = tk.Button(self.login_screen, background = 'teal', font=('AR ESSENCE', '18'), fg='floral white')
        ...
        self.voltar_login = tk.Button(self.tela_novo_usuario, background = 'teal', font=('AR ESSENCE', '18'), fg='floral white')
        ...
        self.salvar_novo_usuario = tk.Button(self.tela_novo_usuario, background = 'teal', font=('AR ESSENCE', '18'), fg='floral white')
        ...
        self.voltar_inicio = tk.Button(self.foruns, image=self.window.voltar)
        ...
        self.tema1 = tk.Button(self.foruns, background = 'teal', font=('AR ESSENCE', '18'), fg='floral white')
        ...
        self.tema2 = tk.Button(self.foruns, background = 'teal', font=('AR ESSENCE', '18'), fg='floral white')
        ...
        self.tema3 = tk.Button(self.foruns, background = 'teal', font=('AR ESSENCE', '18'), fg='floral white')
        ...
        self.tema4 = tk.Button(self.foruns, background = 'teal', font=('AR ESSENCE', '18'), fg='floral white')
        ...
        self.voltar_foruns = tk.Button(self.janela1, image=self.window.voltar)
        ...
        self.botao_janela1 = tk.Button(self.janela1, background = 'teal', font=('AR ESSENCE', '18'), fg='floral white')
        ...
        self.voltar_foruns = tk.Button(self.janela2, image=self.window.voltar)
        self.voltar_foruns.grid(row=0, column=0, columnspan=2, sticky="nsew")
        self.voltar_foruns.configure(text="Voltar")
        self.voltar_foruns.configure(command=self.voltar_aos_foruns)
        ...
        self.botao_janela2 = tk.Button(self.janela2, background = 'teal', font=('AR ESSENCE', '18'), fg='floral white')
        ...
        self.voltar_foruns = tk.Button(self.janela3, image=self.window.voltar)
        self.voltar_foruns.grid(row=0, column=0, columnspan=2, sticky="nsew")
        self.voltar_foruns.configure(text="Voltar")
        self.voltar_foruns.configure(command=self.voltar_aos_foruns)
        ...
        self.botao_janela3 = tk.Button(self.janela3, background = 'teal', font=('AR ESSENCE', '18'), fg='floral white')
        ...
        self.voltar_foruns = tk.Button(self.janela4, image=self.window.voltar)
        self.voltar_foruns.grid(row=0, column=0, columnspan=2, sticky="nsew")
        self.voltar_foruns.configure(text="Voltar")
        self.voltar_foruns.configure(command=self.voltar_aos_foruns)
        ...
        self.botao_janela4 = tk.Button(self.janela4, background = 'teal', font=('AR ESSENCE', '18'), fg='floral white')
